...
// Uses pre-calculated frequency stats from user profiles (tracked from Feb 14, 2026)
...
function displaySkeletonLeaderboard(container) {
  let html = `
    <div style="max-width: 800px; margin: 0 auto; padding: 0 10px;">
      ...
      <p style="text-align: center; color: #ccc; margin-bottom: 8px; font-size: clamp(0.7rem, 2.5vw, 0.9rem); font-family: 'VT323', monospace; line-height: 1.5;">
        Ranked by how frequently they come in for haircuts
      </p>
      <p style="text-align: center; color: #999; margin-bottom: 20px; font-size: clamp(0.6rem, 2vw, 0.75rem); font-family: 'VT323', monospace; font-style: italic;">
        📅 Tracking started Feb 14, 2026
      </p>
  ...
  html += `
      ...
      ">
        ...
        <div style="padding: 12px; background: rgba(206, 17, 38, 0.1); border: 1px solid #CE1126; border-radius: 6px; margin-bottom: 10px;">
          <p style="color: #CE1126; font-size: clamp(0.6rem, 2.5vw, 0.8rem); margin: 0; font-family: 'VT323', monospace;">
            🎯 <strong>Requirements:</strong> You need at least 2 completed haircuts since Feb 14, 2026 to appear on the leaderboard
          </p>
        </div>
        <p style="color: #999; font-size: clamp(0.6rem, 2vw, 0.75rem); line-height: 1.4; font-family: 'VT323', monospace; margin: 0;">
          📊 Stats are calculated daily and updated automatically
        </p>
      </div>
    </div>
  `;
...
async function displayLeaderboard() {
  ...
  html += `
      ...
      ">
        ...
        <p style="color: #999; font-size: clamp(0.6rem, 2vw, 0.75rem); line-height: 1.4; font-family: 'VT323', monospace; margin: 0;">
          📊 Stats are calculated daily from bookings since February 14, 2026
        </p>
      </div>
    </div>
  `;
